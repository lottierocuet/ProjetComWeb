...
<html>
    <head>
        ...
        <title>Annuaire de l'ENSC - Coordonnées</title>
    ...
    <body>
        <div class = "row">
            ...
            <div class = "col-9">
                ...
                <div class ="row">
                    <div class ="col-4"></div>
                    <div class ="Accueil col-8">Ses coordonnées</div>
                </div>
                ...
                <br/>
                <br/>
                <a class = "acces_modif" href= "Annuaire_Experiences.php"> Voir ses expériences </a>
            </div>
        </div>
    </body>
</html>